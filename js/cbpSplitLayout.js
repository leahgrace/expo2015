...
/*$('#splitlayout').click(function(){
	var splitlayout = document.getElementById( 'splitlayout' ),
		 eventtype = mobilecheck() ? 'touchstart' : 'click';
	if($(this).hasClass('left-is-open')){
		$(this).removeClass('left-is-open');
	}
	$(this).addClass('left-is-open');
	splitlayout.querySelector( '.side-left' ).addEventListener( eventtype, backToIntro );
